...
const HomePage = () => {
  ...
  return <div className='flex-[4_4_0] mr-auto border-gray-700 min-h-screen'>
    {/*Header */}
    <div className='flex w-full border-b border-gray-700'>
      ...
      onClick={()=>{setFeedType("forYou")}}> For You { feedType === "forYou" && (<div className='absolute bottom-0 w-10 h-1 roundded-full
      bg-primary'></div>)}
      </div>
      <div className='flex justify-center flex-1 p-3 hover:bg-secondary transition duration-300 cursor-pointer relative'
